              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php
                    $res=$conn->query('SELECT * from tags')->fetchAll();
                    echo"
                      <thead>
                        <tr>
                          <th>Tag Name</th>
                      ...
                      foreach($res as $val){
                        ...
                        <tr>
                          <td>{$val['tag']}</td>
                          <td><a href='editCategory.php?id={$val['tag_id']}'><img src='./images/edit.png' ></a></td>
                          <td><a href='deletecategory.php?id={$val['tag_id']}'><img src='./images/delete.png' ></a></td>
                        </tr>
