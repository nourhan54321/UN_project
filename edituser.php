						...
						<div class='col-md-12 col-sm-12 '>
							<div class='x_panel'>
								...
								<div class='x_content'>
								   ...
								   $id=$_GET['id'];
								   echo"
									<form id='demo-form2' method='post' action='./edit.php?id={$id}' data-parsley-validate class='form-horizontal form-label-left'>

										<div class='item form-group'>
											<label class='col-form-label col-md-3 col-sm-3 label-align' for='first-name'>Full Name <span class='required'>*</span>
											</label>
											<div class='col-md-6 col-sm-6 '>
												<input type='text' id='first-name' required='required' class='form-control ' name='fn'>
											</div>
										</div>
										<div class='item form-group'>
