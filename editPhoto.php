						...
						<div class='col-md-12 col-sm-12 '>
							<div class='x_panel'>
								...
								<div class='x_content'>
									...
									$id=$_GET['id'];
									echo"
									<form id='demo-form2' action='photoupdate.php' method='post' data-parsley-validate class='form-horizontal form-label-left'>
										<div class='item form-group'>
											<label class='col-form-label col-md-3 col-sm-3 label-align' for='photo-date'>Photo Date <span class='required'>*</span>
											</label>
											<div class='col-md-6 col-sm-6 '>
												<input type='date' id='photo-date' required='required' class='form-control' name='dt'>
											</div>
										</div>
										<div class='item form-group'>
										...
										<div class='item form-group'>
											...
											<div class='col-md-6 col-sm-6 '>
												<select class='form-control' name='category' id=''>
													...
													$res=$conn->query("SELECT tag from tags")->fetchAll();
													foreach($res as $val){
														echo"
										...
										<div class='item form-group'>
											<div class='col-md-6 col-sm-6 offset-md-3'>
												...
												<button type='submit' name='sub' class='btn btn-success'>Add</button>
											</div>
										</div>
